...
public class TileOldFiller extends TileBuildCraftEX implements IInventory, IHasWork, IControllable, IBoxProvider{
	...
	@Override
	public void func_145839_a(NBTTagCompound compound) { // readFromNBT
	...
	@Override
	public void func_145841_b(NBTTagCompound compound) { // writeToNBT
