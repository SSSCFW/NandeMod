...
import com.ssscfw.nandemod.inventory.slot.SlotFillerModule;
...
public class ContainerOldFiller extends Container{
    
	public IInventory playerInventory;
	public TileOldFiller fillerEX;
	public int inventorySize;
	public InventoryCrafting crafting;
	public IInventory craftResult = new InventoryCraftResult();

	public ContainerOldFiller(IInventory player, TileOldFiller fillerEX) {
	...
	public ItemStack transferStackInSlot(EntityPlayer player, int i) {
		...
		if(slot != null && slot.getHasStack()) {
			...
			else if(i >= 9 && stack2.getItem() == Alldata.items.get("filler_module")) {
